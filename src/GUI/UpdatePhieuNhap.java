...
public class UpdatePhieuNhap extends javax.swing.JDialog {
	...
	public UpdatePhieuNhap(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) throws UnsupportedLookAndFeelException {
	    ...
	    // Lấy thông tin sản phẩm và phiếu nhập
	    allProduct = MayTinhImpl.getInstance().selectAllExist();
	    this.parent = (PhieuNhapForm) parent;
	    this.phieunhap = this.parent.getPhieuNhapSelect();
	    CTPhieu = ChiTietPhieuNhapImpl.getInstance().selectAll(phieunhap.getMaPhieu());
	    CTPhieuOld = ChiTietPhieuNhapImpl.getInstance().selectAll(phieunhap.getMaPhieu());
	...
	private void displayInfo() {
	    ...
	    txtNguoiTao.setText(AccountImpl.getInstance().selectById(phieunhap.getNguoiTao()).getUser());
	...
	private int loadNccToComboBox() {
	    int vitri = -1;
	    // Tải dữ liệu nhà cung cấp vào combobox và xác định vị trí nhà cung cấp của phiếu nhập
	...
	public final void initTable() {
	    ...
	    tblSanPham.setDefaultEditor(Object.class, null);  // Ngăn chặn chỉnh sửa trực tiếp trên bảng sản phẩm
	}

	private void loadDataToTableProduct(ArrayList<MayTinh> arrProd) {
	    try {
	        tblModel.setRowCount(0);  // Xóa toàn bộ hàng trong bảng
	        for (var i : arrProd) {
	...
	public ChiTietPhieu findCTPhieu(String maMay) {
	    for (var i : CTPhieu) {
	        // Tìm kiếm chi tiết phiếu nhập theo mã máy
	        if (maMay.equals(i.getMaMay())) {
	            return i;
	        }
	    }
	...
	private void loadDataToTableNhapHang() {
	    try {
	        ...
	        tblNhapHangmd.setRowCount(0);  // Xóa toàn bộ hàng trong bảng nhập hàng
    ...
    private void btnNhapHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNhapHangActionPerformed
        ...
        if (CTPhieu.isEmpty()) {
            ...
            for (var ct : CTPhieuOld) {
                MayTinhImpl.getInstance().updateSoLuong(ct.getMaMay(), MayTinhImpl.getInstance().selectById(ct.getMaMay()).getSoLuong() - ct.getSoLuong());
            ...
            try {
                ...
                PhieuNhapImpl.getInstance().update(pn);
                // Xóa chi tiết phiếu nhập cũ
                ChiTietPhieuNhapImpl.getInstance().delete(CTPhieuOld.get(CTPhieuOld.size() - 1));
    ...
    private void deleteProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteProductActionPerformed
        ...
        if (i_row == -1) {
            ...
            // Xóa sản phẩm khỏi danh sách chi tiết phiếu nhập
        ...
        if (i_row == -1) {
            ...
            if (newSL != null) {
                ...
                try {
                    ...
                    // Cập nhật số lượng sản phẩm trong danh sách chi tiết phiếu nhập
    ...
    private void addProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addProductActionPerformed
        ...
        if (i_row == -1) {
            ...
            // Thêm sản phẩm vào danh sách chi tiết phiếu nhập
            ...
            // Cập nhật bảng hiển thị và tổng tiền
            loadDataToTableNhapHang();
            textTongTien.setText(formatter.format(tinhTongTien()) + "đ");
        }
    }
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        // TODO add your handling code here:
        // Tìm kiếm sản phẩm dựa trên từ khóa nhập vào ô tìm kiếm
    ...
    private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetActionPerformed
        // TODO add your handling code here:
        // Reset lại ô tìm kiếm và hiển thị lại tất cả sản phẩm
        txtSearch.setText("");
        loadDataToTableProduct(allProduct);
