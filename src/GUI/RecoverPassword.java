...
public class RecoverPassword extends javax.swing.JDialog {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        AccountImpl.getInstance().updatePassword(txtEmail.getText(),BCrypt.hashpw(password,BCrypt.gensalt(12)));
    ...
    private boolean checkEmail(String email) {
        ArrayList<Account> acc = AccountImpl.getInstance().selectAll();
        for (Account i : acc) {
