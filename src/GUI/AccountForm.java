...
public class AccountForm extends javax.swing.JInternalFrame {
    ...
    private ArrayList<Account> accounts = AccountImpl.getInstance().selectAll();
    ...
    public Account getAccountSelect() {
        ...
        Account acc = AccountImpl.getInstance().selectById(tblAccount.getValueAt(i_row, 1).toString());
        return acc;
    }
        ...
        if (tblAccount.getSelectedRow() == -1) {
            ...
            if (select.getRole().equals("Admin")) {
                ...
                if (checkVl == JOptionPane.YES_OPTION) {
                    try {
                        AccountImpl.getInstance().delete(select);
                        JOptionPane.showMessageDialog(this, "Xoá thành công tài khoản !");
                        loadDataToTable(AccountImpl.getInstance().selectAll());
                    } catch (Exception e) {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                for (int row = 1; row < excelSheet.getLastRowNum(); row++) {
                    ...
                    Account acc = AccountImpl.getInstance().selectById(user);
