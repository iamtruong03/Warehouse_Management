...
public class TonKhoForm extends javax.swing.JInternalFrame {
    ...
    public void loadDataToTable() {
        try {
            MayTinhImpl mtImpl = new MayTinhImpl();
            ArrayList<MayTinh> armt = mtImpl.selectAllE();
    ...
    public void xoaMayTinhSelect() {
        ...
        if (luaChon == JOptionPane.YES_OPTION) {
            MayTinhImpl.getInstance().delete(getMayTinhSelect());
    ...
    public MayTinh getMayTinhSelect() {
        int i_row = tblSanPham.getSelectedRow();
        MayTinh acc = MayTinhImpl.getInstance().selectAll().get(i_row);
        return acc;
    }
