...
public class CTPhieuNhap extends javax.swing.JDialog {
    ...
    public CTPhieuNhap(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) {
        ...
        labelNguoiTao.setText(AccountImpl.getInstance().selectById(pn.getNguoiTao()).getFullName());
    ...
    public void loadDataToTableProduct() {
        try {
            ...
            ArrayList<ChiTietPhieu> CTPhieu = ChiTietPhieuNhapImpl.getInstance().selectAll(this.parent.getPhieuNhapSelect().getMaPhieu().toString());
            ...
            for (int i = 0; i < CTPhieu.size(); i++) {
                tblCTPhieumd.addRow(new Object[]{
                    ...
                    MayTinhImpl.getInstance().selectById(CTPhieu.get(i).getMaMay()).getTenMay(),
