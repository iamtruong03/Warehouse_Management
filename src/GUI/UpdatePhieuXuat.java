...
public class UpdatePhieuXuat extends javax.swing.JDialog {
    ...
    public UpdatePhieuXuat(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) throws UnsupportedLookAndFeelException {
        ...
        CTPhieu = ChiTietPhieuXuatImpl.getInstance().selectAll(phieuxuat.getMaPhieu());
        CTPhieuOld = ChiTietPhieuXuatImpl.getInstance().selectAll(phieuxuat.getMaPhieu());
        // Hien thi thong tin
        initTable();
    ...
    private void displayInfo() {
        ...
        txtNguoiTao.setText(AccountImpl.getInstance().selectById(phieuxuat.getNguoiTao()).getUser());
    }
    ...
    private void btnNhapHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNhapHangActionPerformed
        ...
        if (CTPhieu.isEmpty()) {
            ...
            try {
                PhieuXuatImpl.getInstance().update(pn);
                ChiTietPhieuXuatImpl.getInstance().delete(CTPhieuOld.get(CTPhieuOld.size() - 1));
                for (var i : CTPhieu) {
                    ChiTietPhieuXuatImpl.getInstance().insert(i);
                }
