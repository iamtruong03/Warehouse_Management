...
public class CTThongKe extends javax.swing.JDialog {
    ...
    public void loadDataToTableProduct() {
        try {
            ...
            if (check.contains("PX")) {
                ArrayList<ChiTietPhieu> CTPhieu = ChiTietPhieuXuatImpl.getInstance().selectAll(check);
                ...
                ArrayList<ChiTietPhieu> CTPhieu = ChiTietPhieuNhapImpl.getInstance().selectAll(check);
                for (int i = 0; i < CTPhieu.size(); i++) {
                    tblCTPhieumd.addRow(new Object[]{
                        i + 1,
                        CTPhieu.get(i).getMaMay(),
    ...
    public ArrayList<Phieu> getPhieuAll() {
        ...
        ArrayList<PhieuNhap> conten1 = PhieuNhapImpl.getInstance().selectAll();
        ArrayList<PhieuXuat> conten2 = PhieuXuatImpl.getInstance().selectAll();
