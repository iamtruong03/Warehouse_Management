...
public class PCImpl implements ImplInterface<PC> {

    private static final ConnectionPoolImpl connectionPool = new ConnectionPoolImpl();

    public static PCImpl getInstance() {
        return new PCImpl();
    }
    ...
    public int insert(PC t) {
        int ketQua = 0;
        try {
            Connection con = connectionPool.getConnection("PCImpl");
            ...
            connectionPool.releaseConnection(con, "PCImpl");
