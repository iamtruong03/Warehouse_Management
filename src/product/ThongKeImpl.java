...
public class ThongKeImpl {
    ...
    public static ThongKeImpl getInstance() {
        return new ThongKeImpl();
    }
    ...
    public ArrayList<ThongKeProduct> getThongKe(Date timeStart, Date timeEnd) {
        ...
        Connection con = null;
        try {
            con = connectionPool.getConnection("ThongKeImpl.getThongKe");
            ...
            if (con != null) {
                try {
                    connectionPool.releaseConnection(con, "ThongKeImpl.getThongKe");
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
