...
import product.ChiTietPhieuXuatImpl;
...
public class WritePDF {
    ...
    public void writePhieuNhap(String mapn) {
        ...
        try {
            ...
            PhieuNhap pn = PhieuNhapImpl.getInstance().selectById(mapn);
            ...
            para2.add(String.valueOf("Người tạo: " + AccountImpl.getInstance().selectById(pn.getNguoiTao()).getFullName()));
            para2.add(String.valueOf("\nNhà cung cấp: " + NhaCungCapImpl.getInstance().selectById(pn.getNhaCungCap()).getTenNhaCungCap() + "  -  " + pn.getNhaCungCap()));
            ...
            for (ChiTietPhieu ctpn : ChiTietPhieuNhapImpl.getInstance().selectAll(mapn)) {
                MayTinh mt = MayTinhImpl.getInstance().selectById(ctpn.getMaMay());
    ...
    public void writePhieuXuat(String mapn) {
        ...
        try {
            ...
            PhieuXuat pn = PhieuXuatImpl.getInstance().selectById(mapn);
            ...
            Paragraph para3 = new Paragraph(new Phrase("Người tạo: " + AccountImpl.getInstance().selectById(pn.getNguoiTao()).getFullName(), fontData));
            para1.setIndentationLeft(40);
            para2.setIndentationLeft(40);
            ...
            //Truyen thong tin tung chi tiet vao table
            for (ChiTietPhieu ctpn : ChiTietPhieuXuatImpl.getInstance().selectAll(mapn)) {
                MayTinh mt = MayTinhImpl.getInstance().selectById(ctpn.getMaMay());
                pdfTable.addCell(new PdfPCell(new Phrase(ctpn.getMaMay(), fontData)));
                pdfTable.addCell(new PdfPCell(new Phrase(mt.getTenMay(), fontData)));
                pdfTable.addCell(new PdfPCell(new Phrase(formatter.format(mt.getGia()) + "đ", fontData)));
